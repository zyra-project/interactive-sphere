...
export const STATES: Record<StateKey, StateConfig> = {
  // Behavior —────────────────────────────────────────────────────────
  IDLE:       { label: 'Idle',       orbitSpeed: 0.5,  orbitRadiusScale: 1.00, pupilSize: 1.00, pupilBrightness: 1.00, pupilPulse: false, pupilJitter: 0.00, upperLid: 0.18, lowerLid: 0.14, subMode: 'orbit',     trail: 0.00, head: 'none',  blinkInterval: 4.0, blinkDuration: 0.14 },
  CHATTING:   { label: 'Chatting',   orbitSpeed: 0.5,  orbitRadiusScale: 1.00, pupilSize: 1.20, pupilBrightness: 1.00, pupilPulse: false, pupilJitter: 0.00, upperLid: 0.18, lowerLid: 0.14, subMode: 'orbit',     trail: 0.00, head: 'none',  blinkInterval: 3.5, blinkDuration: 0.14 },
  LISTENING:  { label: 'Listening',  orbitSpeed: 0.3,  orbitRadiusScale: 1.00, pupilSize: 1.15, pupilBrightness: 0.95, pupilPulse: false, pupilJitter: 0.00, upperLid: 0.18, lowerLid: 0.14, subMode: 'listening', trail: 0.00, head: 'none',  blinkInterval: 5.0, blinkDuration: 0.14 },
  TALKING:    { label: 'Talking',    orbitSpeed: 1.2,  orbitRadiusScale: 1.00, pupilSize: 1.20, pupilBrightness: 1.00, pupilPulse: true,  pupilJitter: 0.00, upperLid: 0.14, lowerLid: 0.12, subMode: 'figure8',   trail: 0.55, head: 'none',  blinkInterval: 3.0, blinkDuration: 0.14 },
  ...
  // Emotion —─────────────────────────────────────────────────────────
  CURIOUS:    { label: 'Curious',    orbitSpeed: 0.6,  orbitRadiusScale: 1.00, pupilSize: 1.35, pupilBrightness: 1.05, pupilPulse: false, pupilJitter: 0.05, upperLid: 0.12, lowerLid: 0.12, subMode: 'orbit',     trail: 0.30, head: 'none',  blinkInterval: 3.0, blinkDuration: 0.14 },
